...
class TestExpressions(unittest.TestCase):
    ...
    def test_expressions(self):
        ...
        self.assertEqual(str(TestModel1.field2.upper()), "UPPER(test_model1.field2)")
        self.assertEqual(str(TestModel1.field2.lower()), "LOWER(test_model1.field2)")
        self.assertEqual(str(TestModel1.field1.min()), "MIN(test_model1.field1)")
        self.assertEqual(str(TestModel1.field1.max()), "MAX(test_model1.field1)")
        self.assertEqual(str(TestModel1.field1.sum()), "SUM(test_model1.field1)")
        self.assertEqual(str(TestModel1.field1.average()), "AVG(test_model1.field1)")
